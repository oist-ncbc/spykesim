...
'''
This script contains cythonized pymmh3 functions. Argument data type is restricted to be integer for code optimization.
Below shows the original copyright.

pymmh3 code was written by Fredrik Kihlander and enhanced by Swapnil Gusani, and is placed in the public
domain. 
The authors hereby disclaim copyright to this source code.
...
def hash128(key, int seed = 0x0, x64arch = True ):
    ''' Implements 128bit murmur3 hash. '''
    def hash128_x64(key, int seed ):
